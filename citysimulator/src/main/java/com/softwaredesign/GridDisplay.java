...
public class GridDisplay { 
    ...
    private static final int BUILDING_SELECTOR_WIDTH = 200; // Width of Side Building Selector Element
    ...
    private static final int PANEL_WIDTH = (GRID_COLS * CELL_SIZE); // width of window
    private static final int PANEL_HEIGHT = (GRID_ROWS * CELL_SIZE);  // height of window
    ...
    // JPanel containing a grid and mouse listener detecting which cell is pressed
    static class GridPanel extends JPanel {
        ...
        /**
        * Constructor of the GridPanel object
        * @pre PANEL_WIDTH and PANEL_HEIGHT are int objects
        * @pre BACKGROUND_COLOR and DEFAULT_CELL_COLOR are Color objects
        * @pre GRID_ROWS and GRID_COLS are int objects
        * @post GridPanel is constructed according to given variables
        * @TODO: Implement try and throw exceptions
        */
        public GridPanel() {
        ...
        /**
        * Creates mouse listener for the Grid that detects which cell is clicked
        * @pre GRID_ROWS and GRID_COLS are int objects
        * @post Mouse listener is active and detects the row and column of clicked cells
        * @TODO: Implement try and throw exceptions
        */
        private void CreateMouseListener() {
            addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    int clickedRow = e.getY() / CELL_SIZE;
        ...
        * @pre CELL_SIZE is an int
        * @pre GRID_LINE_COLOR is a Color object
        * @pre GRID_ROWS and GRID_COLS are int objects
        * @post Grid lines and colors are drawn based on given specifications
        * @TODO: Implement try and throw exceptions
        */
        @Override
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            MenuDisplay menu = new MenuDisplay(BUILDING_SELECTOR_WIDTH, PANEL_HEIGHT);
